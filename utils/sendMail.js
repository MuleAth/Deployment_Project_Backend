...
const sendEventNotification = async (userEmail, userName, eventDetails) => {
  ...
  try {
    ...
    const mailOptions = {
      ...
      html: `
        <div style="max-width: 500px; margin: 0 auto; font-family: Arial, sans-serif; background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); border-radius: 10px; overflow: hidden;">
          <div style="background-color: rgba(255,255,255,0.95); margin: 20px; border-radius: 8px; padding: 20px;">
            <div style="text-align: center; margin-bottom: 15px;">
              <div style="background-color: #f5576c; width: 40px; height: 40px; border-radius: 50%; margin: 0 auto 10px; display: flex; align-items: center; justify-content: center;">
                <span style="color: white; font-size: 16px; font-weight: bold;">S</span>
              </div>
              <h2 style="color: #2d3748; margin: 0; font-size: 20px;">New Event Alert</h2>
              <p style="color: #4a5568; margin: 5px 0 0; font-size: 14px;">Hello ${userName}!</p>
            </div>
            
            <div style="background-color: #f8fafc; padding: 12px; border-radius: 6px; margin: 12px 0;">
              <h3 style="color: #4338ca; margin: 0 0 8px; font-size: 16px;">${title}</h3>
              <p style="margin: 3px 0; color: #4a5568; font-size: 13px;"><strong>Category:</strong> ${sportsCategory}</p>
              <p style="margin: 3px 0; color: #4a5568; font-size: 13px;"><strong>Date:</strong> ${startDate}</p>
              <p style="margin: 3px 0; color: #4a5568; font-size: 13px;"><strong>Location:</strong> ${location}</p>
              <p style="margin: 3px 0; color: #4a5568; font-size: 13px;"><strong>Apply by:</strong> ${applyLastDate}</p>
            </div>

            <div style="text-align: center; margin: 15px 0;">
              <a href="https://sportalon-front-i7k9fziv8-atharvs-projects-c46e87c9.vercel.app/events/${eventId}?register=true" style="background-color: #f5576c; color: white; text-decoration: none; padding: 10px 20px; border-radius: 6px; font-weight: bold; display: inline-block; font-size: 14px;">Register Now</a>
            </div>

            <p style="color: #718096; font-size: 12px; margin: 10px 0 0; text-align: center;">Best regards,<br><strong>The Sportalon Team</strong></p>
          </div>
        </div>
      `,
    };
